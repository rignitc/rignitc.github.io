...
loadAchievements(
  'competitions',
  '/rignitc.github.io/src/data/achievements/competitions.json',
  'achievements',
  'empty-placeholder',
...
loadAchievements(
  'startups',
  '/rignitc.github.io/src/data/achievements/startups.json',
  'startups',
  'startups-empty'
);
...
loadAchievements(
  'research',
  '/rignitc.github.io/src/data/achievements/research.json',
  'research',
  'research-empty',
  'view-more-research'
);
