...
loadAchievements(
  'competitions',
  '/pr-preview/pr-15/src/data/achievements/competitions.json',
  'achievements',
  'empty-placeholder',
...
loadAchievements(
  'startups',
  '/pr-preview/pr-15/src/data/achievements/startups.json',
  'startups',
  'startups-empty'
);
...
loadAchievements(
  'research',
  '/pr-preview/pr-15/src/data/achievements/research.json',
  'research',
  'research-empty',
  'view-more-research'
);
