(async function () {
    ...
    function createCard(project, side) {
      ...
      <div class="media" aria-hidden="true">
        <img loading="lazy" src="/pr-preview/pr-15/assets/images/projects/${encodeURIComponent(project.image || 'placeholder-1.jpg')}" alt="${escapeHtml(project.title || '')}">
      </div>
      <div class="info">
    ...
    async function fetchProjects() {
        try {
            const r = await fetch('/pr-preview/pr-15/src/data/projects/projects.json', { cache: 'no-cache' });
