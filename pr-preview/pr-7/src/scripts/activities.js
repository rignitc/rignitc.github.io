...
loadActivities('workshops', '/pr-preview/pr-7/src/data/activities/workshops.json', 'workshops', 'workshops-empty');
loadActivities('exhibitions', '/pr-preview/pr-7/src/data/activities/exhib.json', 'exhibitions', 'exhibitions-empty');
